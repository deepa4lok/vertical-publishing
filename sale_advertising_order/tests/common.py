...
class CommonSaleAdvertisingOrder(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.one_issue_product = cls.env.ref(
            "sale_advertising_order.product_template_digital1"
        )
        cls.multi_issue_product = cls.env.ref(
            "sale_advertising_order.product_template_digital2"
        )
        ...
        cls.product_template_digital1 = cls.env.ref(
            "sale_advertising_order.product_template_digital1"
        )
        cls.product_template_digital2 = cls.env.ref(
            "sale_advertising_order.product_template_digital2"
        )
        cls.product_category_main = cls.env.ref(
            "sale_advertising_order.digital_advertising_category"
        )
        cls.product_category_sub = cls.env.ref(
            "sale_advertising_order.product_category_ads_digital1"
        )
